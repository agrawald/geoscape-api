...
public class SubmitBatchApi
        extends GeoscapeApi<BatchReq, BatchRes> {

    private static final String API = "/v1/batches/batch";

    public SubmitBatchApi(final String url, final String consumerKey) {
        super(url, API, consumerKey);
    }

    public SubmitBatchApi(final String url, final String consumerKey, Proxy proxy) {
